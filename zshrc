...
plugins=(vi-mode git git-extras git-remote-branch gitfast gitflow lol nyan osx brew encode64 urltools rand-quote gem extract pip pylint python screen sudo web-search tmuxinator node npm z)
