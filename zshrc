...
plugins=(git git-extras git-remote-branch gitfast gitflow lol nyan osx brew encode64 urltools rand-quote gem catimg extract pip pylint python screen sudo web-search tmuxinator npm node)
